...
require (
	...
	github.com/hashicorp/terraform-plugin-framework v0.4.3-0.20211004184339-b18ba6cc3517
...
require (
	...
	github.com/bgentry/go-netrc v0.0.0-20140422174119-9fd32a8b3d3d // indirectcontainerd
